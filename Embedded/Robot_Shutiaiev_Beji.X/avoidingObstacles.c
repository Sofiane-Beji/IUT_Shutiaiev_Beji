...
void avoidingObstacles(){
    ...
    int sensorCase = 0;
    float limitS = 44.0; //44.0
    float limitSs = 44.0; //52.0
    ...
    float speedTurn = 13.0;
    float speedSlow = 5.0;
    
    if(sensorCase == 0b0000 || sensorCase == 0b10001){sensorCase = 0;}
    if(sensorCase == 0b00001 || sensorCase == 0b10010){sensorCase = 1;}
    if(sensorCase == 0b00010 || sensorCase == 0b00011 || sensorCase == 0b10011){sensorCase = 2;}
    if(sensorCase == 0b00100 || sensorCase == 0b01110){sensorCase = 4;}
    if(sensorCase >= 0b00101 && sensorCase <= 0b00111){sensorCase = 5;}
    if(sensorCase == 0b01000 || sensorCase == 0b11000 || sensorCase == 0b11001){sensorCase = 8;}
    if(sensorCase == 0b01001 || sensorCase == 0b10000){sensorCase = 9;}
    if(sensorCase == 0b01010 || sensorCase == 0b01011 || sensorCase == 0b1101 || sensorCase == 0b1111){sensorCase = 10;}
    if(sensorCase == 0b01100 || (sensorCase >= 0b10100 && sensorCase <= 0b10111) || (sensorCase >= 0b11010 && sensorCase <= 0b11111)){sensorCase = 12;}
